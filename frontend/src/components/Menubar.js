...
const menu1 = new Menu("FinancialReports", [
    new MenuContentItem(
        "home/financial-reports/balance-sheet-gen",
        "BalanceSheetGen"
    ),
    new MenuContentItem(
        "home/financial-reports/income-sheet-gen",
        "IncomeSheetGen"
    ),
...
const menu2 = new Menu("TransactionManagement", [
    ...
    new MenuContentItem(
        "home/transaction-management/mis-reports",
        "MISReports"
    ),
    new MenuContentItem(
        "home/transaction-management/hefa-manage",
        "HEFARequest"
    ),
    new MenuContentItem(
        "home/transaction-management/letter-of-credit",
        "LetterOfCredit"
    ),
    new MenuContentItem(
        "home/transaction-management/emd-showcase",
        "EMDShowCase"
    ),
]);
...
const menu4 = new Menu("StudentPortal", [
    new MenuContentItem(
        "home/students-portal/hostel-feechallan",
        "HostelFeeChallan"
    ),
    new MenuContentItem(
        "home/students-portal/hostel-checkout",
        "HostelCheckOut"
    ),
